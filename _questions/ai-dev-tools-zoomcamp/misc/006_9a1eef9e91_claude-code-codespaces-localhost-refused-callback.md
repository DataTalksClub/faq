...
If this still doesn't resolve it, check Anthropic's [Troubleshoot installation and login](https://code.claude.com/docs/en/troubleshoot-install) docs for other known causes.
